...
SOPCINFO_FILE := F:/Qsys/qsys_sdram/qsys/hardware/sdram.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4001000
SOPC_SYSID_FLAG += --sidp=0x4001000
ELF_PATCH_FLAG  += --sidp 0x4001000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1539590655
SOPC_SYSID_FLAG += --timestamp=1539590655
ELF_PATCH_FLAG  += --timestamp 1539590655
