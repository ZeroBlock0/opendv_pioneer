...
SOPCINFO_FILE := D:/project/5_qsys_timer/qsys/hardware/qsys_timer.sopcinfo
...
# Design Name 
# setting SOPC_NAME is qsys_timer
SOPC_NAME := qsys_timer
...
# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1548058308
SOPC_SYSID_FLAG += --timestamp=1548058308
ELF_PATCH_FLAG  += --timestamp 1548058308
