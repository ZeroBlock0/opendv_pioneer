...
SOPCINFO_FILE := F:/project/qsys_ucosii_task_time/qsys/hardware/system_qsys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2002028
SOPC_SYSID_FLAG += --sidp=0x2002028
ELF_PATCH_FLAG  += --sidp 0x2002028

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1550039760
SOPC_SYSID_FLAG += --timestamp=1550039760
ELF_PATCH_FLAG  += --timestamp 1550039760
