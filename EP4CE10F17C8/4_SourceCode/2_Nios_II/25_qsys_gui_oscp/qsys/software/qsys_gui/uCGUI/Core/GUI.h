...
#define GUI_LIGHTWHITE	  0XCCCCCC
#define GUI_LIGHTGRAY     0xD3D3D3
#define GUI_GRAY          0x808080
#define GUI_DARKGRAY      0x101010
#define GUI_LIGHTDARK     0x202020
#define GUI_DEEPDARK      0x040404
#define GUI_BLACK         0x000000

#define GUI_BROWN         0x2A2AA5

#define GUI_BUTTON_COLOR  0xAAAAAA

#define GUI_INVALID_COLOR 0xFFFFFFF      /* Invalid color - more than 24 bits */

//mine color
#define GUI_BLUEIGHTBLUE  0xFF4040
#define GUI_VERYLIGHTCYAN 0xFFFFC0
...
extern GUI_CONST_STORAGE GUI_FONT GUI_FontChinese_ST20,	  Chinese_ST20;
extern GUI_CONST_STORAGE GUI_FONT GUI_FontChinese_ST16,	  Chinese_ST16;
...
void GUI_FillUpCircle	  (int x0, int y0, int r);
