...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4003040
SOPC_SYSID_FLAG += --sidp=0x4003040
ELF_PATCH_FLAG  += --sidp 0x4003040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1552895859
SOPC_SYSID_FLAG += --timestamp=1552895859
ELF_PATCH_FLAG  += --timestamp 1552895859
