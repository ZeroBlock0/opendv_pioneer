// system_qsys_alt_vip_cl_scl_0.v

// This file was auto-generated from alt_vip_cl_scl_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 13.1 162 at 2019.04.02.17:09:34

`timescale 1 ps / 1 ps
module system_qsys_alt_vip_cl_scl_0 #(
		...
		parameter MAX_IN_WIDTH        = 800,
		parameter MAX_IN_HEIGHT       = 480,
		parameter MAX_OUT_WIDTH       = 1280,
		parameter MAX_OUT_HEIGHT      = 800,
		parameter RUNTIME_CONTROL     = 1,
		parameter ALWAYS_DOWNSCALE    = 0,
		parameter ALGORITHM_NAME      = "NEAREST_NEIGHBOUR",
	...
	wire   [55:0] line_buffer_av_st_dout_0_data;                // line_buffer:av_st_dout_data_0 -> scaler_core:av_st_din_data
	...
	wire          scheduler_av_st_cmd_5_endofpacket;            // scheduler:av_st_cmd_5_endofpacket -> control_slave:av_st_cmd_endofpacket
	wire          scheduler_av_st_cmd_5_valid;                  // scheduler:av_st_cmd_5_valid -> control_slave:av_st_cmd_valid
	wire          scheduler_av_st_cmd_5_startofpacket;          // scheduler:av_st_cmd_5_startofpacket -> control_slave:av_st_cmd_startofpacket
	wire   [63:0] scheduler_av_st_cmd_5_data;                   // scheduler:av_st_cmd_5_data -> control_slave:av_st_cmd_data
	wire          scheduler_av_st_cmd_5_ready;                  // control_slave:av_st_cmd_ready -> scheduler:av_st_cmd_5_ready
	wire          control_slave_av_st_resp_endofpacket;         // control_slave:av_st_resp_endofpacket -> scheduler:av_st_resp_2_endofpacket
	wire          control_slave_av_st_resp_valid;               // control_slave:av_st_resp_valid -> scheduler:av_st_resp_2_valid
	wire          control_slave_av_st_resp_startofpacket;       // control_slave:av_st_resp_startofpacket -> scheduler:av_st_resp_2_startofpacket
	wire   [63:0] control_slave_av_st_resp_data;                // control_slave:av_st_resp_data -> scheduler:av_st_resp_2_data
	wire          control_slave_av_st_resp_ready;               // scheduler:av_st_resp_2_ready -> control_slave:av_st_resp_ready
	...
	wire   [55:0] line_buffer_av_st_dout_data;                  // port fragment
	...
	generate
		...
		if (ALGORITHM_NAME != "NEAREST_NEIGHBOUR")
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
	...
	system_qsys_alt_vip_cl_scl_0_scaler_core scaler_core (
		.clock                    (main_clock),                             // main_clock.clk
		.reset                    (main_reset),                             // main_reset.reset
	...
	alt_vip_scaler_scheduler #(
		...
		.av_st_cmd_5_valid          (scheduler_av_st_cmd_5_valid),             //  av_st_cmd_5.valid
		.av_st_cmd_5_startofpacket  (scheduler_av_st_cmd_5_startofpacket),     //             .startofpacket
		.av_st_cmd_5_endofpacket    (scheduler_av_st_cmd_5_endofpacket),       //             .endofpacket
		.av_st_cmd_5_data           (scheduler_av_st_cmd_5_data),              //             .data
		.av_st_cmd_5_ready          (scheduler_av_st_cmd_5_ready),             //             .ready
		.av_st_resp_2_valid         (control_slave_av_st_resp_valid),          // av_st_resp_2.valid
		.av_st_resp_2_startofpacket (control_slave_av_st_resp_startofpacket),  //             .startofpacket
		.av_st_resp_2_endofpacket   (control_slave_av_st_resp_endofpacket),    //             .endofpacket
		.av_st_resp_2_data          (control_slave_av_st_resp_data),           //             .data
		.av_st_resp_2_ready         (control_slave_av_st_resp_ready),          //             .ready
	...
	alt_vip_control_slave #(
		...
		.av_st_cmd_valid             (scheduler_av_st_cmd_5_valid),            //     av_st_cmd.valid
		.av_st_cmd_startofpacket     (scheduler_av_st_cmd_5_startofpacket),    //              .startofpacket
		.av_st_cmd_endofpacket       (scheduler_av_st_cmd_5_endofpacket),      //              .endofpacket
		.av_st_cmd_data              (scheduler_av_st_cmd_5_data),             //              .data
		.av_st_cmd_ready             (scheduler_av_st_cmd_5_ready),            //              .ready
	...
	assign line_buffer_av_st_dout_0_data = { line_buffer_av_st_dout_data[55:0] };
