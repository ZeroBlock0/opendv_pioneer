...
SOPCINFO_FILE := F:/project/qsys_gui_comprehensive_test/qsys/hardware/system_qsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is system_qsys
SOPC_NAME := system_qsys
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2002470
SOPC_SYSID_FLAG += --sidp=0x2002470
ELF_PATCH_FLAG  += --sidp 0x2002470

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1554196137
SOPC_SYSID_FLAG += --timestamp=1554196137
ELF_PATCH_FLAG  += --timestamp 1554196137
