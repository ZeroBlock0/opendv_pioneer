...
SOPCINFO_FILE := F:/Qsys/qsys_eth/qsys/hardware/nios2os.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2002780
SOPC_SYSID_FLAG += --sidp=0x2002780
ELF_PATCH_FLAG  += --sidp 0x2002780

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1547178543
SOPC_SYSID_FLAG += --timestamp=1547178543
ELF_PATCH_FLAG  += --timestamp 1547178543
