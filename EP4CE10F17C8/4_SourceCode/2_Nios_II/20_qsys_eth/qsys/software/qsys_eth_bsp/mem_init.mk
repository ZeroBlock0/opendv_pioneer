...
MEM_0 := nios2os_descriptor_memory
...
$(MEM_0)_START := 0x02002400
$(MEM_0)_END := 0x020025ff
...
# Memory: ext_flash
MEM_1 := nios2os_ext_flash_boot_rom
...
.PHONY: ext_flash
ext_flash: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym $(MEM_1).flash
