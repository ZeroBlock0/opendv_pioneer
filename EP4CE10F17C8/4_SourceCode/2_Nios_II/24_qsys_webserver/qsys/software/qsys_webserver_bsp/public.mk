...
SOPCINFO_FILE := F:/Qsys/qsys_webserver/qsys/hardware/nios2os.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1ed0
SOPC_SYSID_FLAG += --sidp=0x1ed0
ELF_PATCH_FLAG  += --sidp 0x1ed0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1548746340
SOPC_SYSID_FLAG += --timestamp=1548746340
ELF_PATCH_FLAG  += --timestamp 1548746340
