...
SOPCINFO_FILE := D:/work/Pio_irq/qsys/hardware/irq.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1020
SOPC_SYSID_FLAG += --sidp=0x1020
ELF_PATCH_FLAG  += --sidp 0x1020

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1532086233
SOPC_SYSID_FLAG += --timestamp=1532086233
ELF_PATCH_FLAG  += --timestamp 1532086233
