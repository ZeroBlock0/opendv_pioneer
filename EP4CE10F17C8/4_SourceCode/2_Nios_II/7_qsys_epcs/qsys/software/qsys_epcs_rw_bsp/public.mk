...
SOPCINFO_FILE := D:/project/qsys_epcs/qsys/hardware/qsys_epcs.sopcinfo
...
# Design Name 
# setting SOPC_NAME is qsys_epcs
SOPC_NAME := qsys_epcs
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x12000
SOPC_SYSID_FLAG += --sidp=0x12000
ELF_PATCH_FLAG  += --sidp 0x12000

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1550980342
SOPC_SYSID_FLAG += --timestamp=1550980342
ELF_PATCH_FLAG  += --timestamp 1550980342
