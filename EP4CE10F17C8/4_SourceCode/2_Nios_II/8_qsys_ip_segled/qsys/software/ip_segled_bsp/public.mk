...
SOPCINFO_FILE := D:/project/qsys_ip_segled/qsys/hardware/system_qsys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x9010
SOPC_SYSID_FLAG += --sidp=0x9010
ELF_PATCH_FLAG  += --sidp 0x9010

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1555990627
SOPC_SYSID_FLAG += --timestamp=1555990627
ELF_PATCH_FLAG  += --timestamp 1555990627
