...
SOPCINFO_FILE := D:/project/qsys_Nios_II_colorbar/qsys/hardware/qsys.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x40020b0
SOPC_SYSID_FLAG += --sidp=0x40020b0
ELF_PATCH_FLAG  += --sidp 0x40020b0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1543545716
SOPC_SYSID_FLAG += --timestamp=1543545716
ELF_PATCH_FLAG  += --timestamp 1543545716
